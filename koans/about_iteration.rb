...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is a method that accumulates a result by passing each element
    # of the collection to a block, starting with an initial value (0 or 1 here).
    # The block takes two arguments: the current accumulated result and the next item.
  end
